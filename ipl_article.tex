...
\centering
	...
	\includegraphics[width=0.46\textwidth]{im_ndcg10leprefbm25.png}
	\label{fig:bm25}}
	\subfigure[Compression rate achieved by applying Elias-$\delta$ to the UTI values produced by UTI-LambdaMART in the  index when (CR) x NDCG@10;]{
	\includegraphics[width=0.46\textwidth]{im_cr_ndcg_lambda.png}
	\label{fig:crq}}
\end{figure*}
